        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> <span class="fw-medium">{{ $historiqueAlert->idalert }}</span></td>
                        ...
                        <td>{{ $historiqueAlert->Status }} <span class="badge bg-label-success me-1">Completed</span>
                        </td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-success"
                                        href="{{url('/admin/alerts/history/regenerate/'.$historiqueAlert->id) }}"><i
                                            class="bx bx-repeat me-1"></i> regenerate</a>
                                    <a class="dropdown-item text-danger"
                                        href="{{ url('/admin/alerts/history/delete/'.$historiqueAlert->id) }}"><i
