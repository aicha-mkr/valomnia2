    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form id="editForm" action="{{ route('email.update', $template->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <h5>Configure Report Text</h5>
                    <textarea class="form-control" id="rapport-content" name="content" rows="6"
                        placeholder="Enter the report content here..." required>{{ $template->content }}</textarea>
                </div>
            ...
            ">
                  ...
                  ">
                                                        ...
                                                        <p id="rapport-template-text"
                                                            ...
                                                            Callously piranha however moronic selfless more
                                                            because
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="o_bg-white o_sans o_text-xs o_text-light o_px-md o_pt-xs"
                                                        ...
                                                        <p style="margin-top: 0px;margin-bottom: 0px;">TOP 5
                                                            PRODUCTS
                                                        </p>
