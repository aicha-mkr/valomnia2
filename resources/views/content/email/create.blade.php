...
<div class="row">
    ...
    <div id="rapportTemplate" class="col-md-8" style="display: none;">
        ...
        <div class="card mb-6">
            ...
            ">
              ...
              ">
                      ...
                      ">
                        ...
                        <table data-module="pricing-3cols" data-visible="false"
                                ...
                                <tr>
                                    ...
                                    <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
                                        ...
                                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td id="kpi-list" class="o_re o_bg-white o_px o_pb-md"
                                                        align="center" data-bgcolor="Bg White" style="
                      font-size: 0;
                      vertical-align: top;
                      background-color: #ffffff;
                      padding-left: 16px;
                    ...
                    ">
                                                        <h4 class="o_heading o_text-dark o_mb-xs" data-color="Dark"
                                                            data-size="Heading 4" data-min="10" data-max="26" style="
                      font-family: Helvetica, Arial, sans-serif;
                      font-weight: bold;
                      margin-top: 0px;
                      margin-bottom: 8px;
                    ...
                    ">
                                                        ...
                                                        <div id="kpi1" class="o_col o_col-2 o_col-full"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="o_bg-ultra_light o_br o_px o_py-md o_sans o_text o_text-secondary"
                                                                                ...
                                                                                data-size="Text Default" data-min="12"
                                                                                data-max="20" data-color="Secondary"
                                                                                style="
                                  font-family: Helvetica, Arial, sans-serif;
                                  margin-top: 0px;
                                  margin-bottom: 0px;
                                ...
                                ">
                                                                                ...
                                                                                <h2 id="kpiValue1"
                                                                                    ...
                                                                                    data-max="40" data-color="Primary"
                                                                                    style="
                                    font-family: Helvetica, Arial, sans-serif;
                                    font-weight: bold;
                                    margin-top: 0px;
                                  ...
                                  ">
                                                                        ...
                                                                        <tr>
                                                                            <td class="o_py o_sans o_text-xs o_text-secondary"
                                                                                align="center" data-color="Secondary"
            ...
            <div id="kpi2" class="o_col o_col-2 o_col-full"
                style="display: inline-block; vertical-align: top; width: 100%; max-width: 180px">
                ...
                <div class="o_px-xs" style="padding-left: 8px; padding-right: 8px">
                    <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_br o_px o_py-md o_sans o_text o_text-secondary"
                                    align="center" data-bgcolor="Bg Ultra Light" data-size="Text Default" data-min="12"
                                    data-max="20" data-color="Secondary" style="
                                  font-family: Helvetica, Arial, sans-serif;
                                  margin-top: 0px;
                                  margin-bottom: 0px;
                                  font-size: 16px;
                                ...
                                ">
                                    ...
                                    <h2 id="kpiValue2" class="o_heading o_text-primary" data-size="Heading 2"
                                        data-min="20" data-max="40" data-color="Primary" style="
                                    font-family: Helvetica, Arial, sans-serif;
                                    font-weight: bold;
                                    margin-top: 0px;
                                    margin-bottom: 0px;
                            ...
                            <tr>
                                <td class="o_py o_sans o_text-xs o_text-secondary" align="center" data-color="Secondary"
                                    data-size="Text XS" data-min="10" data-max="18" style="
                                  font-family: Helvetica, Arial, sans-serif;
                                  margin-top: 0px;
                                  margin-bottom: 0px;
                                  font-size: 14px;
                                ...
                                ">
                                    ...
                                    <table align="center" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_btn o_bg-dark o_br o_heading o_text-xs" align="center"
                                                    data-bgcolor="Bg Dark" data-size="Text XS" data-min="10"
                                                    data-max="18" style="
                                          font-family: Helvetica, Arial, sans-serif;
                                          font-weight: bold;
                                          margin-top: 0px;
            ...
            <!--[if mso]></td><td width="200" align="center" valign="top" style="padding: 0px 8px;"><![endif]-->
            <div id="kpi3" class="o_col o_col-2 o_col-full"
                        ...
                        <tbody>
                            <tr>
                                ...
                                ">
                                    ...
                                    <h2 id="kpiValue3" class="o_heading o_text-primary" data-size="Heading 2"
                                        data-min="20" data-max="40" data-color="Primary" style="
                                    font-family: Helvetica, Arial, sans-serif;
                                    font-weight: bold;
                                    margin-top: 0px;
                                        ...
                                        <td class="o_re o_bg-white o_px o_pt" align="center" data-bgcolor="Bg White"
                                            ...
                                            <div class="o_col o_col-1 o_col-full"
                                                ...
                                                <div class="o_px-xs o_sans o_text o_center" data-size="Text Default"
                                                    ...
                                                    <p style="margin-top: 0px;margin-bottom: 0px;"><a
                                                            class="o_text-primary" href="https://example.com/"
                                                            data-color="Primary"
                                            ...
                                            <div class="o_col o_col-3 o_col-full"
                                                ...
                                                <div class="o_px-xs o_sans o_text-xs o_text-secondary o_left o_xs-center"
                                                    ...
                                                    <p class="o_mb-xxs" style="margin-top: 0px;margin-bottom: 4px;">Less
                                            ...
                                            <div class="o_col o_col-2 o_col-full"
                                                ...
                                                <div class="o_px-xs o_sans o_text-xxs o_text-light o_right o_xs-center"
                                                    data-color="Light" data-size="Text XXS" data-min="8" data-max="16"
                                                    ...
                                                    <div style="font-size: 8px; line-height: 8px; height: 8px;">&nbsp;
                                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light"
                                            align="center" data-color="Light" data-size="Text XS" data-min="10"
                                            data-max="18" data-border-top-color="Border Light"
                                            ...
                                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©2025 Valomnia
                                            </p>
    ...
    <div class="card mb-6">
        <div class="card-body">
            ...
            <div>
                ...
                <body>
                    <table data-module="preview-text" data-visible="false" width="100%" cellspacing="0" cellpadding="0"
                        border="0" role="presentation">
                        <tbody>
                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
                                                    data-bgcolor="Bg Dark" data-size="Text Default" data-min="12"
                                                    data-max="20"
                                            ...
                                            <tr>
                                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary"
                                                    ...
                                                    <p id="template-text" style="margin-top: 0px;margin-bottom: 0px;">
                                                        Welcome to B2B Valomnia! We're excited to have you on board.</p>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="300"
                                                                    ...
                                                                    data-bgcolor="Bg Success" data-size="Text Default"
                                                                    data-min="12" data-max="20"
                                                                    ...
                                                                    <a class="o_text-white" id="alert-link"
                                                                        href="https://example.com/" data-color="White"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light"
                                                    ...
                                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©2006
                                                        Valomnia</p>
