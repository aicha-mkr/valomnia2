...
<body>
<table data-module="preview-text" data-visible="false" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
  <tbody>
  <tr>
      ...
      <table class="o_block-xs" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 432px;margin: 0 auto;">
        ...
        <tr>
          <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" data-bgcolor="Bg Ultra Light" data-color="Light" data-size="Text MD" data-min="15" data-max="23" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
            ...
            <h2 class="o_heading o_text-dark o_mb-xxs" id="template-title" data-color="Dark" data-size="Heading 2" data-min="20" data-max="40" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">{{ $title }}</h2>
          </td>
        </tr>
        </tbody>
      </table>
        ...
        <tr>
          <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="left" data-bgcolor="Bg White" data-color="Secondary" data-size="Text Default" data-min="12" data-max="20" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
            ...
            @if(isset($expired_products) && count($expired_products) > 0)
              ...
              @endphp
              <table class="stock-table" width="100%" cellspacing="0" cellpadding="0">
                <thead>
                <tr>
                  <th style="padding: 8px; text-align: left; font-weight: bold; border: 1px solid #d3dce0;">Produit</th>
                  <th style="padding: 8px; text-align: left; font-weight: bold; border: 1px solid #d3dce0;">Entrepôt</th>
                  <th style="padding: 8px; text-align: left; font-weight: bold; border: 1px solid #d3dce0;">Quantité</th>
                  <th style="padding: 8px; text-align: left; font-weight: bold; border: 1px solid #d3dce0;">Seuil</th>
                </tr>
                </thead>
                <tbody>
                @foreach($expired_products as $product)
                  <tr>
                    <td style="padding: 8px; border: 1px solid #d3dce0;"><span class="product-name">{{ $product['product_name'] }}</span></td>
                    <td style="padding: 8px; border: 1px solid #d3dce0;"><span class="warehouse-name">{{ $product['warehouse_name'] }}</span></td>
                    <td style="padding: 8px; border: 1px solid #d3dce0;"><span class="quantity-alert">{{ $product['quantity'] }}</span></td>
                    <td style="padding: 8px; border: 1px solid #d3dce0;"><span class="threshold-value">{{ $product['threshold'] }}</span></td>
                  </tr>
                @endforeach
                </tbody>
              </table>
              ...
              <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <tr>
                  <td width="300" class="o_btn o_bg-success o_br o_heading o_text" id="alert-button" align="center" data-bgcolor="Bg Success" data-size="Text Default" data-min="12" data-max="20" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #0ec06e;border-radius: 4px; display: none;">
                    <a class="o_text-white" id="alert-link" href="{{ $btn_link }}" data-color="White" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">{{ $btn_name }}</a>
                  </td>
                </tr>
                </tbody>
              </table>
