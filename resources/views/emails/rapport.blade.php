...
<table data-module="stats-3cols" data-visible="false" data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2018/11/19/pcVNfzKjZ3goPqkxr2hYT0ws/service_canceled/thumbnails/stats-3cols.png" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
  <tbody>
    <tr>
      <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
        ...
        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
          <tbody>
            <tr>
              <td class="o_re o_bg-white o_px o_pb-md" align="center" data-bgcolor="Bg White" style="font-size: 0;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                ...
                <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                  ...
                  <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                      <tbody>
                        <tr>
                          <td id="kpi1" class="o_bg-ultra_light o_br o_text-xs o_sans o_px o_py-md" align="center" data-bgcolor="Bg Ultra Light" data-size="Text XS" data-min="10" data-max="18" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                            <h1 class="o_heading o_text-dark" data-color="Dark" data-size="Heading 1" data-min="26" data-max="46" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 36px;line-height: 47px;">1,241</h1>
                            <p class="o_text-light" data-color="Light" style="color: #82899a;margin-top: 0px;margin-bottom: 0px;">followers</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                  ...
                  <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                      <tbody>
                        <tr>
                          <td id="kpi2" class="o_bg-ultra_light o_br o_text-xs o_sans o_px o_py-md" align="center" data-bgcolor="Bg Ultra Light" data-size="Text XS" data-min="10" data-max="18" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                            <h1 class="o_heading o_text-dark" data-color="Dark" data-size="Heading 1" data-min="26" data-max="46" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 36px;line-height: 47px;">6,874</h1>
                            <p class="o_text-light" data-color="Light" style="color: #82899a;margin-top: 0px;margin-bottom: 0px;">appreciations</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                  ...
                  <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                      <tbody>
                        <tr>
                          <td id="kpi3" class="o_bg-ultra_light o_br o_text-xs o_sans o_px o_py-md" align="center" data-bgcolor="Bg Ultra Light" data-size="Text XS" data-min="10" data-max="18" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                            <h1 class="o_heading o_text-dark" data-color="Dark" data-size="Heading 1" data-min="26" data-max="46" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 36px;line-height: 47px;">26</h1>
                            <p class="o_text-light" data-color="Light" style="color: #82899a;margin-top: 0px;margin-bottom: 0px;">projects</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
